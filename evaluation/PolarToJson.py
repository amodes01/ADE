...
attitudes_dir = './brexit-test/attitudes/'
output_dir = './brexit-test/formatted-attitudes/'
...
for root, dirs, files in os.walk(attitudes_dir):
    for filename in files:
        if filename.endswith('.pckl'):
            ...
            relative_path = os.path.relpath(root, attitudes_dir)  # relative subpath
            output_subdir = os.path.join(output_dir, relative_path)
            os.makedirs(output_subdir, exist_ok=True)  # make sure output subdir exists
